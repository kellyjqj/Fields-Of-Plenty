...
object DateUtil :
  ...
  extension (data : String)
    ...
    //      catch
    //        case  e: DateTimeParseException => null // null bad practice, return an option of date better
    //
    //    def isValid : Boolean =
    ...
    def parseLocalDate: Option[LocalDate] =
      try
        ...
        case e: DateTimeParseException => None // null bad practice, return an option of date
